const hoursData = {
  ...
  totals: [10140, 9200, 12410, 4000, 500, 1200, 75000, 2210]
};
...
function getCumulativeData(total, years, label) {
  ...
  for (let i = 0; i < years.length; i++) {
    ...
    switch (label) {
      case "School (1-10)":
        if (year < 2008 || year > 2020) increment = 0;
        break;
      case "Studying":
      ...
      case "Football":
        ...
        else if (year === 2010) increment *= 2.2; // peak
        else if (year > 2016) increment *= 0.5;
        break;
      case "Gaming":
      ...
      case "Traveling":
        ...
        break;
      case "Sleeping":
        if (year < 2010) increment *= 1.4;
        else if (year > 2023) increment *= 0.9;
        break;
      case "Working":
